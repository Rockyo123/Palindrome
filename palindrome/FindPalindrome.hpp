...
private:
	...
	int numPal; //number of palindromes found
	std::vector<std::string> currentSentence;	//holds the current sentence that we are trying to find the vectors in
	std::vector<std::vector<std::string>> palindromes;	//holds all of the sentences that are palindromes
	std::vector<std::string> currentPalindrome;	//holds the current palindrome being calculated
